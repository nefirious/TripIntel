      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b-4 border-[#1e1e24] pb-8">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            <GraduationCap className="w-10 h-10 text-[#5ce1e6]" />
        ...
        <div className="flex flex-col items-center">
          <div className={`w-20 h-20 rounded-full border-4 border-[#1e1e24] ${getScoreColor(snapshot.overallScore)} flex items-center justify-center text-3xl font-black shadow-[4px_4px_0px_0px_#1e1e24]`}>
            {snapshot.overallScore}
          </div>
          <span className="text-[10px] font-black uppercase tracking-widest mt-2">Overall Score</span>
        </div>
      </div>
