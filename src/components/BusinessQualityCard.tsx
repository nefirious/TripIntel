      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b-4 border-[#1e1e24] pb-6 sm:pb-8">
        <div className="space-y-2 w-full">
          <div className="flex items-center gap-3">
            <Briefcase className="w-8 h-8 sm:w-10 h-10 text-[#ffde59]" />
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tighter">{snapshot.city} Business Intel</h2>
          </div>
        ...
        <div className="flex flex-row md:flex-col items-center gap-4 md:gap-2 w-full md:w-auto justify-between md:justify-center bg-gray-50 md:bg-transparent p-4 md:p-0 rounded-xl md:rounded-none border-2 md:border-0 border-[#1e1e24] md:border-transparent">
          <div className={`w-14 h-14 sm:w-20 h-20 rounded-full border-4 border-[#1e1e24] ${getScoreColor(snapshot.overallFriendlinessScore)} flex items-center justify-center text-xl sm:text-3xl font-black shadow-[3px_3px_0px_0px_#1e1e24] sm:shadow-[4px_4px_0px_0px_#1e1e24]`}>
            {snapshot.overallFriendlinessScore}
          </div>
          <span className="text-[8px] sm:text-[10px] font-black uppercase tracking-widest">Friendliness Score</span>
        </div>
      </div>
